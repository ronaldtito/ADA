...
void bucketSort(vector<T>& List, int size) {
    ...
    for (int i = 0; i < size; i++)
        sort(bucket[i].begin(), bucket[i].end(),myfunction);
...
int main() {
    ...
    cout << "Time Heap :  " << chrono::duration_cast<chrono::microseconds>(end - start).count() <<  endl;

    start = chrono::steady_clock::now();
    mergeSort(Listas[1], 0, n - 1);
    end = chrono::steady_clock::now();
    cout << "Time Merge : " <<  chrono::duration_cast<chrono::microseconds>(end - start).count() << endl;

    start = chrono::steady_clock::now();
    //quickSort(Listas[2], 0, n - 1);
    end = chrono::steady_clock::now();
    cout << "Time Quick: " << chrono::duration_cast<chrono::microseconds>(end - start).count() <<  endl;
    
    start = chrono::steady_clock::now();
    shellSort(Listas[3], n);
    end = chrono::steady_clock::now();
    cout << "Time Shell: " << chrono::duration_cast<chrono::microseconds>(end - start).count() <<  endl;


    //bucketSort(Listas[4], n);
    start = chrono::steady_clock::now();
    radixSort(Listas[5], n);
    end = chrono::steady_clock::now();
    cout << "Time Radix: " << chrono::duration_cast<chrono::microseconds>(end - start).count() <<  endl;
